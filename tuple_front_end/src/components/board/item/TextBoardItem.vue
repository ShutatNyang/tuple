<template>
  <div
    class="flex items-center gap-4 bg-[#fcf8f9] px-4 min-h-[72px] py-2 justify-between cursor-pointer"
    @click="goToDetail"
  >
    <div class="flex items-center gap-4">
      <div
        class="text-[#1d0c12] flex items-center justify-center rounded-lg bg-[#f4e6eb] shrink-0 size-12"
        data-icon="User"
        data-size="24px"
        data-weight="regular"
      >
      ...
      <div class="flex flex-col justify-center">
        <p
          class="text-[#1d0c12] text-base font-medium leading-normal line-clamp-1"
        >
          {{ item.title }}
        </p>
        <p
          class="text-[#a14563] text-sm font-normal leading-normal line-clamp-2"
        >
